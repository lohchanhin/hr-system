...
describe('Department API', () => {
  ...
  it('creates department', async () => {
    ...
    const payload = {
      ...
      code: 'D1',
      organization: 'org1',
      institutionCode: 'IC-001',
      uniformNumber: '12345678',
      laborInsuranceNumber: 'LAB12345',
      healthInsuranceNumber: 'HEA12345',
  ...
  it('updates department', async () => {
    ...
    const payload = {
      name: 'HR',
      organization: 'org1',
      institutionCode: 'IC-002',
      uniformNumber: '87654321',
      laborInsuranceNumber: 'LAB54321',
      healthInsuranceNumber: 'HEA54321',
      taxRegistrationNumber: 'TAX54321',
      location: '新北',
      phone: '02-87654321',
      responsiblePerson: '林負責',
      manager: '王主管',
      defaultTwoDayOff: false,
      tempChangeAllowed: true,
      deptManager: 'mgr1',
