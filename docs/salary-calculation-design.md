...
- 事假（扣薪比例 100%）：1天 × 2,174 × 100% = 2,174 元
- 病假（扣薪比例 50%）：1天 × 2,174 × 50% = 1,087 元
- 特休（扣薪比例 0%）：1天 × 2,174 × 0% = 0 元
...
例如：平日加班 4 小時（前2小時 + 後2小時）
```
加班費 = (2 × 272 × 1.34) + (2 × 272 × 1.67)
       = 729 + 908
       = 1,637 元
```
...
勞退提繳 = 月薪 × 6%（雇主提繳，屬於雇主成本，不從員工薪資扣除）
勞退自提 = 月薪 × 自提比例（0-6%，員工自願提繳，從薪資扣除）
```
...
1. **日薪與時薪**
```
日薪 = 50,000 ÷ 22 = 2,273 元/天
時薪 = 50,000 ÷ 22 ÷ 8 = 284 元/小時
```

2. **請假扣款**
```
特休扣款 = 2 × 2,273 × 0% = 0 元
事假扣款 = 1 × 2,273 × 100% = 2,273 元
總扣款 = 2,273 元
```
...
4. **加班費**
```
前 2 小時 = 2 × 284 × 1.34 = 761 元
第 3-4 小時 = 2 × 284 × 1.67 = 948 元
第 5-6 小時 = 2 × 284 × 1.67 = 948 元
總加班費 = 2,657 元
```
